...
export default function Testimonials() {
  return (
    <div className='flex '>
      <div className=''>
        <img src='/images/testimonialsPhoto.png' alt='testimonials' />
      </div>
      ...
      <img src='/images/testi-photo.png' alt='client' />
      ...
      <img className='object-cover' src='/images/testimonialsPhoto2.png' alt='testimonials' />
      </div>
    </div>
  )
}
