  ...
  return (
    <div className='w-full py-20'>
        <div className='flex w-[1280px] mx-auto'>
            <div className='w-1/2'>
                <img className='object-cover' src='/images/about-image-2.png' alt='about photo' />
            </div>
            <div className='w-1/2 flex flex-col justify-center gap-2 pr-10'>
                ...
                <h4 className={`${roboto.className} font-bold text-5xl`}>We do Creative Things for Success</h4>
                ...
                <div className='flex mt-2'>
                    <div className='flex items-center'>
                        <img className='w-[80px] h-[80px]' src='/images/icon.png' alt='icon' />
                        <div>
                            <h4 className={`${roboto.className} text-xl font-bold`}>Modern Agriculture Equipment</h4>
                        </div>
                    </div>
                    <div className='flex items-center'>
                        <img className='w-[80px] h-[80px]' src='/images/icon2.png' alt='icon' />
                        <div>
