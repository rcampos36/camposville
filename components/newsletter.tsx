...
export default function Newsletter() {
  return (
    <div className='relative w-[1080px] mx-auto py-20 max-sm:my-10 max-sm:py-1 max-sm:w-full max-sm:px-4'>
      ...
      <div className='absolute top-0 max-sm:z-10 gap-5 max-sm:gap-0 items-center max-sm:h-8 h-full w-full max-sm:w-[400px] flex max-sm:flex-col justify-between p-10 max-sm:p-4'>
