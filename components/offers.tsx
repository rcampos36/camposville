...
export default function Offers() {
  return (
    <div className='bg-[color:var(--primary-blue-color)] mt-20'>
        <div className='w-[1080px] max-sm:w-full mx-auto text-white flex flex-col items-center py-20 gap-5'>
            ...
            <div className='flex gap-4 max-sm:w-full max-sm:px-4 max-sm:flex-col'>
